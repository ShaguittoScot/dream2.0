...
const BasketballProfile = () => {
  ...
  initial={{ opacity: 0 }}
  animate={{ opacity: 1 }}
  className="w-full h-[560px] md:h-[600px] relative -mx-8 overflow-hidden shadow-2xl"
>
  <img
  ...
  <motion.header
    ...
    className="bg-white/95 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-gray-100/80 max-w-7xl mx-auto"
  >
  ...
  {/* ********** FIN HEADER DEL JUGADOR ********** */}
       ...
       {/* ********** INICIO MAIN CONTENT ********** */}
        <main className="grid lg:grid-cols-2 gap-8 -mt-1">
