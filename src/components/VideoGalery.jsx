      ...
      <div className="relative flex flex-col lg:flex-row w-full bg-black max-w-6xl mx-auto rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="w-full lg:w-1/3 bg-black text-white p-4 flex flex-col justify-between">
          ...
          <div className="flex justify-end mt-4">
            <button
              onClick={nextVideo} // Llama a la función nextVideo al hacer clic
            ...
            >
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                <button className="text-white shadow-md">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M20.4086 9.35258C22.5305 10.5065 22.5305 13.4935 20.4086 14.6474L7.59662 21.6145C5.53435 22.736 3 21.2763 3 18.9671L3 5.0329C3 2.72368 5.53435 1.26402 7.59661 2.38548L20.4086 9.35258Z" stroke="#f4a244" stroke-width="1.5"/>
                  </svg>
                </button>
              </div>
