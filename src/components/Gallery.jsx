...
const Gallery = ({ images }) => {
  ...
  <h2 className="text-center text-4xl sm:text-5xl md:text-6xl font-extrabold mb-16 bg-clip-text text-transparent bg-gradient-to-r from-[#23878e] to-[#d24d33] font-arvo tracking-wide">
    GALERIA
  </h2>

  {/* Mosaico de imágenes */}
  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-4 w-full max-w-6xl">
  ...
  <AnimatePresence>
    {lightboxOpen && (
      ...
      >
        <motion.div
          className="relative w-[90%] sm:w-3/4 lg:w-2/3 max-w-4xl"
          initial={{ scale: 0.9 }}
          animate={{ scale: 1 }}
          exit={{ scale: 0.9 }}
